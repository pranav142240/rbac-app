...
@php
$icons = [
    'home' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9,22 9,12 15,12 15,22"/>',
    ...
    'settings' => '<circle cx="12" cy="12" r="3"/><path d="m12 1 1.09 4.5a4.5 4.5 0 0 0 1.37.73L19 5l2 3.46-3.72 3.22a4.5 4.5 0 0 0 0 1.46L21 16.5 19 20l-4.54-1.27a4.5 4.5 0 0 0-1.37.73L12 23l-1.09-4.5a4.5 4.5 0 0 0-1.37-.73L5 19l-2-3.46 3.72-3.22a4.5 4.5 0 0 0 0-1.46L3 7.5 5 4l4.54 1.27a4.5 4.5 0 0 0 1.37-.73L12 1Z"/>',
    'test' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>',
...
$iconPath = $icons[$name] ?? $icons['circle'];
@endphp
