<x-layouts.app>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-gray-500 flex items-center mt-1">
                        ...
                        <a href="{{ route('profile.edit') }}" class="text-blue-600 hover:text-blue-800">{{ __('Manage') }}</a>
                    </p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    @can('create', App\Models\Organization::class)
                        <a href="{{ route('organizations.create') }}" class="inline-flex items-center text-sm text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
                ...
                @if(Auth::user()->organizations->count() > 0)
                            ...
                            <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center mr-3">
                                        <x-icon name="office-building" class="h-5 w-5 text-blue-600 dark:text-blue-400" />
                                    </div>
                                    <div>
                                ...
                                <div class="flex items-center space-x-2">
                                    @can('view', $organization)
                                        <a href="{{ route('organizations.show', $organization) }}" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
                    ...
                    @if(Auth::user()->organizations->count() > 3)
                        <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                            <a href="{{ route('organizations.index') }}" class="inline-flex items-center text-sm text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
                ...
                @else
                    <div class="text-center py-8">
                        ...
                        @can('create', App\Models\Organization::class)
                            <a href="{{ route('organizations.create') }}" class="mt-2 inline-flex items-center text-sm text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div class="p-6">                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="{{ route('organization-groups.index') }}" class="inline-flex items-center text-sm text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
                            ...
                            <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center mr-3">
                                        <x-icon name="user-group" class="h-5 w-5 text-green-600 dark:text-green-400" />
                                    </div>
                                    <div>
                                        <h3 class="text-sm font-medium text-gray-900 dark:text-gray-100">
                                            {{ $group->name }}
                                    ...
                                    <a href="{{ route('organization-groups.show', $group) }}" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
                                        <x-icon name="eye" class="h-4 w-4" />
                                    </a>
                                </div>
                            </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden mb-6">
        <div class="p-6">
            ...
            <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                <a href="{{ route('auth.profile') }}" class="inline-flex items-center text-sm text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
    ...
    <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg shadow-sm border border-blue-200 dark:border-blue-800 overflow-hidden">
        <div class="p-6">
            <h2 class="text-lg font-medium text-blue-900 dark:text-blue-100 mb-2">{{ __('Multi-Authentication System') }}</h2>
